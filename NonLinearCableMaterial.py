...
# FIXME: something fucky comes this way with NR iterations
...
data = {"Final X":((f"{uHistoryUC[-1]:.3f}"), "mm"), "Final Y":((f"{vHistoryUC[-1]:.3f}"), "mm"),
"Stress 1":((f"{stressUC[0]:.2f}"), "MPa"), "Stress 2":((f"{stressUC[1]:.2f}"), "MPa")}
OutputTable(rows=data, columnTitles=("Uncorrected"), title="Simulation Results")
